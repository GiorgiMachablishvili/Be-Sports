...
//        let minutes = (Int(remainingTime) % 3600) / 60
//        let seconds = Int(remainingTime) % 60
//        timeLabel.text = String(format: "%02d HOURS  %02d MIN  %02d SEC", hours, minutes, seconds)
//    }
...
//            attributes: [.font: UIFont.boldSystemFont(ofSize: 32), .foregroundColor: UIColor(hexString: "FFFFFF")]
//        )
//
//        let labelString = NSAttributedString(
//            string: "HOURS       MIN       SEC",
//            attributes: [.font: UIFont.latoThin(size: 12), .foregroundColor: UIColor(hexString: "FFFFFF").withAlphaComponent(0.4)]
//        )
//
...
//        let seconds = Int(remainingTime) % 60
//
//        // Create the formatted time string with spacing
//        let timeString = String(format: "%02d   :   %02d   :   %02d\n", hours, minutes, seconds)
//
//        // Create the formatted label string for "HOURS", "MIN", "SEC"
//        let labelString = "HOURS    MIN    SEC"
//
//        // Define the styling for the numbers (bold & larger)
...
//        )
//
//        // Define the styling for the labels (smaller, lighter)
//        let attributedLabelString = NSAttributedString(
//            string: labelString,
//            attributes: [
...
//        )
//
//        // Append labels below the numbers
//        attributedTimeString.append(attributedLabelString)
//
//        // Apply to label
